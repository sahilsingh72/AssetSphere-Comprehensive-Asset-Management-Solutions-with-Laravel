                                ...
                                <div class="card-people mt-auto">
                                    ...
                                    <div class="weather-info">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-2">
                                                <h2 class="mb-0 font-weight-normal" id="weather-temp">--<sup>C</sup></h2>
                                                <h3 class="location font-weight-normal" id="location-city">--</h3>
                                                <h4 class="font-weight-normal" id="location-country">--</h4>
                                                <h4 class="font-weight-normal" id="current-date">--</h4>
                        ...
                        <div class="col-md-6 grid-margin transparent">
                            <div class="row">
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-tale" title="Click to know About All Asset">
                                        <div class="card-body">
                                            <div class="flex gap-4"><i class="fas fa-cogs fa-2x mb-3"></i>
                                                <p class="mb-4 font-bold fa-1x">Total Assets</p>
                                            </div>
                                            <p class="fs-30 mb-2">4006</p>
                                            <!-- <p>More Info <i class="fas fa-info-circle"></i></p> -->
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4 stretch-card transparent">
                                ...
                                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                                    <div class="card card-light-blue">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-4">Total Maintenance</p>
